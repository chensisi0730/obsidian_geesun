...
source: https://wiki.seeedstudio.com/cn/simulate_soarm101_by_leisaac/
author:
...
> info
> 
> 如果您使用的是 50 系列 GPU，我们建议使用 isaacsim5.0 和 isaaclab 的 feature/isaacsim\_5\_0 分支。
...
![](https://files.seeedstudio.com/wiki/reComputer-Jetson/leisaac/connect_arm.png)
...
```
![](https://www.youtube.com/watch?v=XY3LEXGP8hI)

进入 IsaacLab 窗口后，按下键盘上的 `b` 键以开始远程操作。随后，您可以通过指定的远程操作设备（teleop\_device）在仿真环境中控制机器人。完成操作后，若需重置环境，只需按下 `r` 键或 `n` 键。其中， `r` 键表示重置环境并将任务标记为失败，而 `n` 键表示重置环境并将任务标记为成功。

![](https://www.youtube.com/watch?v=XkgBY4aa8AE)
...
python scripts/environments/teleoperation/replay.py \
    ...
    --episode_index=0
```
![](https://www.youtube.com/watch?v=C6KHxKRsWx0)
...
```
![](https://files.seeedstudio.com/wiki/reComputer-Jetson/leisaac/data_conversion.png)
...
```
![](https://www.youtube.com/watch?v=LPSxPMoP-pk)
...
python scripts/gr00t_finetune.py \
   ...
   --batch_size 2
```
![](https://files.seeedstudio.com/wiki/reComputer-Jetson/leisaac/train.png)
...
```
![](https://files.seeedstudio.com/wiki/reComputer-Jetson/leisaac/server.png)
...
![](https://www.youtube.com/watch?v=GRzFK7o3lOQ)
